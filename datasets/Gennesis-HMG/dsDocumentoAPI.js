...
function callService(documentId, version, time) {
	...
	var response = serviceActive.getDocumentVersion(user, pass, 1, documentId, version, '4ef20412-7687-40a4-b1c8-095c0a92503e');
	...
	var response = service.updateDocument(user, pass, 1, documentDtoArray, attachmentArray, documentSecurityConfigDtoArray, approverDtoArray, relatedDocumentDtoArray);
	return response;
}
