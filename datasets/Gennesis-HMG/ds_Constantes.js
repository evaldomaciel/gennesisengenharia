...
function valores() {
    return [
        ...
        { 'id': 'rm_senha', 'Valor': '@Totvs123456', 'descrição': 'Dados de usuário para integração com RM' }, /** Antes: QFRvdHZzMTIzNDU2 */
        { 'id': 'fluig_usuario', 'Valor': 'suporte.fluig', 'descrição': 'Dados de usuário para integração interna do Fluig' },
        { 'id': 'fluig_senha', 'Valor': 'Fluig@2022*', 'descrição': 'Dados de usuário para integração interna do Fluig' },
