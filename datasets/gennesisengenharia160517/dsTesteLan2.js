...
function callService(fields, constraints, sortFields) {
	...
	var response = customClient.readRecord(getParamValue(params.dataServerName, assigns.dataServerName), getParamValue(params.primaryKey, assigns.primaryKey), 
...
dataset.addColumn('error');
	...
	var primaryKey = isPrimitive(params.primaryKey) ? params.primaryKey : JSONUtil.toJSON(params.primaryKey);
	var contexto = isPrimitive(params.contexto) ? params.contexto : JSONUtil.toJSON(params.contexto);

	dataset.addRow([error.message, dataServerName, primaryKey, contexto]);
