function validateForm(form) {
  ...
  if (activity == 4 || activity == 0) {
    ...
    if (form.getValue("pagamento_realizado_pp") == "Sim") {
      ...
      if (form.getValue("data_pagamento_inicial") == "" || form.getValue("data_pagamento_inicial") == null) {
          msg += '<br><b>O campo <font color="red">Data de Pagamento Inicial</font> \u00E9 obrigat\u00F3rio!</b>';
      }
      ...
      if (form.getValue("data_pagamento_final") == "" || form.getValue("data_pagamento_final") == null) {
          msg += '<br><b>O campo <font color="red">Data de Pagamento Final</font> \u00E9 obrigat\u00F3rio!</b>';
      }
    }
  }
